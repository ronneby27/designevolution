        ...
        <div class="content full-height">
            ...
            <div class="resize-carousel-holder vis-info">
                ...
                <div class="full-width-slider-holder">
                    <!--  full-width-slider --> 
                    <div class="<?php echo (count(get_attached_media('image')) > 1)?'full-width-slider owl_carousel':'';?>">
                        <?php foreach(get_attached_media('image') as $image){ 
                            $image_url = wp_get_attachment_image_src($image->ID, 'fullhd');
                        ?>
                            <!-- 1--> 
                            <div class="item">
                                <div class="bg bg-slider" style="background-image:url(<?php echo $image_url[0]; ?>)"></div>
                                <div class="zoomimage"><img src="<?php echo $image_url[0]; ?>" class="intense" alt=""><i class="fa fa-expand"></i></div>
